...
<div class="panel">
    <div class="panel-body">
        <div class="alert-success text-center" style="height:50px">
            <h3 style="line-height: 50px">公司认证申请</h3>
        </div>
    </div>
</div>
<ul id="myTab" class="nav nav-tabs">
    ...
    <li>
        <a href="#2" data-toggle="tab">已确认</a>
    </li>
...
<div id="myTabContent" class="tab-content">
    ...
    <div class="tab-pane fade" id="2">
        <table id="dataShow2" class="table table-hover"></table>
    </div>
</div>
...
<script>
    ...
    $('#dataShow').bootstrapTable({
        ...
        url:"getCompanyListByStatus",//要请求数据的文件路径
